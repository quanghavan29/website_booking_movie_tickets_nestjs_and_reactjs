    ...
    return (
        ...
        <div className="p-4 lg:w-1/5" style={{ cursor: 'pointer' }}
            ...
            <div className="max-w-xs rounded-md shadow-md bg-coolGray-50 text-coolGray-800">
                <img src={movie.imageUrl} alt="" className="object-cover object-center w-full rounded-t-md h-full bg-coolGray-500" />
                <div className="flex flex-col justify-between p-3 space-y-8 text-center">
                    <div>
                        ...
                        <p style={{ color: "#777777", fontSize: 14 }} className="text-coolGray-800">{movie.timeLimit} Phút - {movie.premiere}</p>
                    </div>
                </div>
            </div>
        </div >
